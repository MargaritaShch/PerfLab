...
<ul>
  ...
  },
  {
    id: 2,
    question:
      'Какие основные принципы объектно-ориентированного программирования (ООП) поддерживает Java?',
    answer: `
...
public class Main {
  ...
  },
  {
    id: 7,
    question:
      'Что такое конструктор в Java и как он используется для инициализации объекта?',
    answer: `
...
Person person2 = new Person("Alice");  // имя "Alice", возраст по умолчанию 0
  ...
  },
  {
    id: 8,
    question:
      'Каковы отличия между статическими методами и методами экземпляра в Java?',
    answer: `
...
class MyBankAccount {
  ...
  },
  {
    id: 10,
    question:
      'Как работать с наследованием в Java и для чего оно используется?',
    answer: `
...
public class Main {
  ...
  },
  {
    id: 14,
    question:
      'Как работают исключения (exceptions) в Java и как они обрабатываются?',
    answer: `
...
try (BufferedReader reader = new BufferedReader(new InputStreamReader(System.in))) {
  ...
  },
  {
    id: 15,
    question:
      'Как использовать `try-catch-finally` для обработки исключений в Java?',
    answer: `
...
public String input() throws MyException {
  ...
  },
  {
    id: 16,
    question:
      'Что такое коллекторы (Garbage Collection) в Java и как они работают?',
    answer: `
...
public class CommandLineExample {
  ...
  },
  {
    id: 18,
    question:
      'Какие существуют коллекции в Java (например, `ArrayList`, `HashMap`, `Set`) и как с ними работать?',
    answer: `
...
public class GenericsExample {
  ...
  },
  {
    id: 20,
    question:
      'Как работает цикл `for-each` в Java и когда его следует использовать?',
    answer: `
...
baz
  ...
  },
  {
    id: 21,
    question:
      'Как организовать многопоточность в Java (классы `Thread` и интерфейс `Runnable`)?',
    answer: `
...
switch (protocol) {
  ...
  },
  {
    id: 27,
    question:
      'Как подключать и использовать сторонние библиотеки в Java с помощью Maven или Gradle?',
    answer: `
...
dependencies {
  ...
  },
  {
    id: 31,
    question:
      'Что такое Stream API в Java и как его использовать для обработки коллекций?',
    answer: `
...
<p>Функциональные интерфейсы — это основа для использования лямбда-выражений и функционального программирования в Java. Они позволяют создавать более лаконичный, гибкий и читаемый код, особенно в сочетании со Stream API и другими функциональными возможностями языка.</p>
  ...
  },
  {
    id: 34,
    question:
      'Что такое CompletableFuture и как использовать асинхронные задачи в Java?',
    answer: `
...
<p>Рефлексия — это мощный инструмент, который позволяет динамически взаимодействовать с программой во время её выполнения. Однако она нарушает принципы инкапсуляции, поэтому ее следует использовать с осторожностью, так как злоупотребление рефлексией может привести к сложностям в отладке и поддержке кода.</p>
  ...
  },
  {
    id: 36,
    question:
      'Как реализовать Dependency Injection в Java с использованием Spring?',
    answer: `
...
<p>Использование Dependency Injection в Spring значительно упрощает разработку и тестирование Java-приложений. Spring предоставляет гибкие и удобные способы управления зависимостями с помощью аннотаций, конфигурационных классов и XML-файлов. DI улучшает модульность кода, упрощает его тестирование и поддержку, а также стимулирует использование хороших архитектурных практик.</p>
  ...
  },
  {
    id: 37,
    question:
      'Что такое микросервисы в контексте Java и как их создавать с помощью Spring Boot?',
    answer: `
...
<p>Микросервисы в контексте Java и Spring Boot предоставляют гибкость и масштабируемость для создания распределенных приложений. С помощью Spring Boot можно быстро разрабатывать, конфигурировать и разворачивать микросервисные приложения, что делает его идеальным выбором для построения современных микросервисных архитектур.</p>
  ...
  },
  {
    id: 38,
    question:
      'Как работает виртуальная машина Java (JVM) и что такое сборка мусора (Garbage Collection)?',
    answer: `
...
<p>JVM играет ключевую роль в обеспечении кроссплатформенности Java-приложений, управляя выполнением байт-кода и памятью. Сборка мусора — важная функция JVM, которая автоматически освобождает память от ненужных объектов, позволяя избежать утечек памяти и улучшить управление ресурсами. Понимание принципов работы JVM и различных алгоритмов сборки мусора помогает оптимизировать производительность Java-приложений.</p>
  ...
  },
  {
    id: 39,
    question:
      'Что такое JPA и как организовать работу с базами данных с использованием Hibernate?',
    answer: `
  ...
  },
  {
    id: 40,
    question:
      'Что такое паттерны проектирования и какие из них можно использовать в Java?',
    answer: `
