...
print(reversed_arr)  # Вывод: [5, 4, 3, 2, 1]</code></pre>
    ...
    public static void main(String[] args) {
      ...
      `,level:"MIDDLE"}],Wu={props:{question:Object},data(){return{likes:0,comments:[],newComment:""}},computed:{levelText(){return`Level: ${this.question.level}`},levelClass(){return{"level-intern":this.question.level==="INTERN","level-junior":this.question.level==="JUNIOR","level-middle":this.question.level==="MIDDLE"}}},methods:{goToDetail(){this.$router.push(`/questions/${this.question.id}`)},likeQuestion(){this.likes++},addComment(){this.newComment.trim()&&(this.comments.push(this.newComment.trim()),this.newComment="")}}},Gu={class:"question-text"};function Qu(e,t,n,s,r,o){return Qe(),ht("div",{onClick:t[5]||(t[5]=(...i)=>o.goToDetail&&o.goToDetail(...i)),class:"question-card"},[se("h3",Gu,Tt(n.question.question),1),se("p",{class:On([o.levelClass,"level-text"])},Tt(o.levelText),3),se("div",{class:"like-section",onClick:t[1]||(t[1]=Er(()=>{},["stop"]))},[se("button",{onClick:t[0]||(t[0]=(...i)=>o.likeQuestion&&o.likeQuestion(...i)),class:"like-button"},"👍 "+Tt(r.likes)+" Like",1)]),se("div",{class:"comments-section",onClick:t[4]||(t[4]=Er(()=>{},["stop"]))},[t[6]||(t[6]=se("h4",null,"Комментарии:",-1)),se("ul",null,[(Qe(!0),ht(Te,null,xo(r.comments,(i,l)=>(Qe(),ht("li",{key:l,class:"comment-item"},Tt(i),1))),128))]),yo(se("textarea",{"onUpdate:modelValue":t[2]||(t[2]=i=>r.newComment=i),placeholder:"Добавьте комментарий"},null,512),[[Nc,r.newComment]]),se("button",{onClick:t[3]||(t[3]=(...i)=>o.addComment&&o.addComment(...i)),class:"add-comment-button"},"Добавить комментарий")])])}const zu=kn(Wu,[["render",Qu],["__scopeId","data-v-612ef44e"]]),Yu={components:{QuestionCard:zu},data(){return{questions:fi,currentLevel:"ALL",selectedAction:"ALL",shuffledQuestions:[]}},computed:{filteredQuestions(){return this.selectedAction==="SHUFFLE"?this.shuffledQuestions:this.currentLevel==="ALL"?this.questions:this.questions.filter(e=>e.level===this.currentLevel)}},methods:{handleAction(){this.selectedAction==="SHUFFLE"?this.shuffleQuestions():this.filterLevel(this.selectedAction)},filterLevel(e){this.currentLevel=e},shuffleQuestions(){this.shuffledQuestions=[...this.questions].sort(()=>Math.random()-.5)}}},Xu={class:"filter-section"},Zu={class:"question-grid"};function ea(e,t,n,s,r,o){const i=Ls("QuestionCard");return Qe(),ht("div",null,[se("div",Xu,[yo(se("select",{"onUpdate:modelValue":t[0]||(t[0]=l=>r.selectedAction=l),id:"levelFilter",onChange:t[1]||(t[1]=(...l)=>o.handleAction&&o.handleAction(...l))},t[2]||(t[2]=[Zl('<option value="ALL" data-v-3dd75600>Все уровни</option><option value="INTERN" data-v-3dd75600>Intern</option><option value="JUNIOR" data-v-3dd75600>Junior</option><option value="MIDDLE" data-v-3dd75600>Middle</option><option value="SHUFFLE" data-v-3dd75600>Перемешать вопросы</option>',5)]),544),[[Lc,r.selectedAction]])]),se("div",Zu,[(Qe(!0),ht(Te,null,xo(o.filteredQuestions,l=>(Qe(),Jo(i,{key:l.id,question:l},null,8,["question"]))),128))])])}const ta=kn(Yu,[["render",ea],["__scopeId","data-v-3dd75600"]]),na={data(){return{question:null}},created(){const e=parseInt(this.$route.params.id);this.question=fi.find(t=>t.id===e)}},sa={key:0,class:"question-detail"},ra={class:"question-text"},oa={class:"answer-box"},ia=["innerHTML"];function la(e,t,n,s,r,o){const i=Ls("router-link");return r.question?(Qe(),ht("div",sa,[se("h2",ra,Tt(r.question.question),1),se("div",oa,[se("div",{innerHTML:r.question.answer,class:"answer-text"},null,8,ia)]),ae(i,{to:"/",class:"back-button"},{default:vo(()=>t[0]||(t[0]=[Wo("← Back to Questions")])),_:1})])):ec("",!0)}const ca=kn(na,[["render",la],["__scopeId","data-v-aad3acc8"]]),ua=[{path:"/",component:ta},{path:"/questions/:id",component:ca}],aa=Ju({history:Eu(),routes:ua});qc(Bc).use(aa).mount("#app");
